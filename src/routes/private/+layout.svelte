...
<AppBar
	background="bg-fuchsia-100 border-b border-fuchsia-300"
	gridColumns="grid-cols-3"
	slotDefault="place-self-center"
	slotTrail="place-content-end"
>
	<svelte:fragment slot="lead"
		><a class="text-xl font-semibold hover:text-purple-500" href="/private/trips">Trips</a
		></svelte:fragment
	>
	...
	<svelte:fragment slot="trail">
		...
		<div class="card w-36 space-x-1 space-y-3 p-4 shadow-xl" data-popup="popupFeatured">
			<a href="/private/profile" class="flex items-center space-x-2 hover:text-purple-500">
				<LucideUser size="16" />
				<span>View Profile</span>
			</a>
			<button onclick={logout} class="flex items-center space-x-2 hover:text-purple-500">
